...
internal class Tokenizer
{
    ...
    public static IList<Token> Parse(string input)
    {
            ...
            switch (lastCharId)
            {
                ...
                case CharId.Digit:
                    ...
                    else
                    {
                        ...
                        {
                            if (decimal.TryParse(s[..^1], out decimal @uint))
                                tokens.Add(new Token
                                {
                                    Id = TokenId.Decimal,
                                    Index = currCharIndex,
                        ...
                        {
                            if (double.TryParse(s[..^1], out double @uint))
                                tokens.Add(new Token
                                {
                                    Id = TokenId.Double,
                                    Index = currCharIndex,
                        ...
                        {
                            if (float.TryParse(s[..^1], out float @uint))
                                tokens.Add(new Token
                                {
                                    Id = TokenId.Float,
                                    Index = currCharIndex,
                        ...
                        {
                            if (ulong.TryParse(s[..^2], out ulong @uint))
                                tokens.Add(new Token
                                {
                                    Id = TokenId.ULong,
                                    Index = currCharIndex,
                        ...
                        {
                            if (long.TryParse(s[..^1], out long @uint))
                                tokens.Add(new Token
                                {
                                    Id = TokenId.Long,
                                    Index = currCharIndex,
                        ...
                        {
                            if (uint.TryParse(s[..^1], out uint @uint))
                                tokens.Add(new Token
                                {
                                    Id = TokenId.UInt,
                                    Index = currCharIndex,
                            ...
                            else if (ulong.TryParse(s[..^1], out ulong @ulong))
                                tokens.Add(new Token
                                {
                                    Id = TokenId.ULong,
                                    Index = currCharIndex,
        ...
        ThrowException:
            var segment_Before = currCharIndex + sb.Length - 7 >= 0 ? input.Substring(currCharIndex + sb.Length - 7, 7) : input[..(currCharIndex + sb.Length)];
