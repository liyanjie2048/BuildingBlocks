...
public static class Extensions
{
    public static void AddValueObjects(this RuntimeTypeModel model)
    {
        ...
        model.Add(typeof(Sensitive), false).Add(nameof(Sensitive.Value), nameof(Sensitive.Status));
    ...
    public static void AddValueObject_Sensitive<TStatus>(this RuntimeTypeModel model)
    {
        model.Add(typeof(Sensitive<TStatus>), false).Add(nameof(Sensitive.Value), nameof(Sensitive.Status));
    }
